...
localization_bn_rIN_table = {
    ...
    click_to_get_help="Mi ব্যান্ড বিযেয়ে আরো জানুন",
    ...
    unlock_hint_info="স্বয়ংক্রিয়ভাবে আপনার ডিভাইস আনলক করতে আপনার ব্যান্ড ব্যবহার করুন।",
    ...
    no_data_hint_0="মার্কিন যুক্তরাষ্ট্রের নিদ্রা প্রতিষ্ঠান প্রতিরাত্রে ৭-৮ ঘন্টা ঘুমের পরামর্শ দেয়।",
    no_data_hint_1="পুনরাবৃত্তি হল সাফল্যের জনক।",
    no_data_hint_2="অগ্রগতির জন্য সংগ্রাম, উৎকর্ষতার জন্য নয়।",
    no_data_hint_3="আপনি যত ধীরে দৌড়ান না কেন, তবুও সোফায় বসে থাকা প্রতিটি মানুষের থেকে এগিয়ে আছেন।",
    not_binded_hint="এই অ্যাকাউন্টে সাথে কোনো ব্যান্ড যুক্ত করা হয়নি।",
    ...
    challenge_format="একটি সারিতে %d দিনের জন্য আপনি আপনার লক্ষ্য ছুঁয়ে ফেলেছেন!",
    personal_best_format="আপনার দীর্ঘতম সফলতা বা বিফলতার পুনরাবৃত্তির সময়সীমা হল %d দিন!",
    ...
    continue_used_n_skips_format="একটি পর পর %d দিনের জন্য আপনি আপনার লক্ষ্য ছুঁয়েছেন! আপনার কাছে এখনও %d টি অলস দিন আছে",
    continue_used_0_skips_format="একটি সারিতে %d দিনের জন্য আপনি আপনার লক্ষ্য ছুঁয়ে ফেলেছেন! আপনার একটিও অলস দিন বাকি নেই।",
    personal_best_on_skip_day_title="সফলতা বা বিফলতার পুনরাবৃত্তির সময়সীমা %d দিন! আপনি একটি অলস দিন পেয়েছেন!",
    personal_best_on_skip_day_info="সফলতা বা বিফলতার পুনরাবৃত্তির সময়সীমার প্রতি7- দিন পরে আপনি একটি অলস দিন পাবেন। যখন আপনি আপনার লক্ষ্যে পৌঁছবেন না তখন আপনি অলস দিনগুলি ব্যবহার করতে পারেন।",
    manual_lazy_title="আপনি আজ আপনার লক্ষ্যে পৌঁছাতে পারেননি।",
    manual_lazy_subtitle="যদি আজকের দিনটি অলস দিন হিসাবে চিহ্নিত করেন তবে আপনার সফলতা বা বিফলতার পুনরাবৃত্তির সময়সীমা বজায় থাকবে।",
    ...
    manual_fail_ytd_title = "গতকাল আপনি আপনার সফলতা বা বিফলতার পুনরাবৃত্তির সময়সীমা সমাপ্ত করেছেন।",
    manual_fail_ytd_subtitle = "সফলতা বা বিফলতার পুনরাবৃত্তির সময়সীমা %d দীর্ঘ ছিল।",

    active_time_format_0="%dমিনিট",
    active_time_format_1="%dঘন্টা",
    active_time_format_2="%dঘন্টা %dমিনিট",
    activie_run_format_0=" %s দৌড়েছেন। দারুণ করেছেন!",
    activie_run_format_1="%s দৌড়েছেন। আপনি খুব ভালো করছেন!",
    activie_run_format_2="%s দৌড়েছেন।",
    activie_run_consumed="Burned %dcal. %s",

    get_distance_format="প্রায় %dমিনিট।",
    ...
    activity_activity_format_run="%s %s অনুশীলন করেছেন, %s দৌড়েছেন",
    last_night_sleeped_good_format="গত রাত্রে আপনি %s ঘুমিয়েছেন।",
    last_night_sleeped_normal_format="গতরাত্রে আপনি %s ঘুমিয়েছেন।",
    deep_sleep_format="%s গভীর ঘুম হয়েছিল।",

    battery_low_info="আপনার ব্যান্ডে চার্জ দিন",
    battery_very_low_info="আপনার ব্যান্ডের ব্যাটারির মাত্রা কমে গেছে।",

    cannot_find_bracelet="আপনার ব্যান্ড খুঁজে পাওয়া যাবে না।",
    cannot_find_bracelet_info="সুনিশ্চিত হয়ে নিন যে আপনার ব্যান্ডের ব্যাটারি চার্জ করা হয়েছে।",
